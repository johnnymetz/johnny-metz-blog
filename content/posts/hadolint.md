...
Misconfigured Docker containers can be slow, heavy and difficult to maintain. This leads to sluggish releases, high storage costs and frustrated developers. Moreover, inadequate Docker containers can be a major security liability. A recent report by Aqua Security found that [50% of new Docker instances are attacked within 56 minutes](https://www.aquasec.com/news/2021-cloud-native-threat-report-reveals-new-threats/) of being deployed. Docker problems can be devastating for any business and software teams need to put in the time and energy to alleviate these risks.

[Hadolint](https://github.com/hadolint/hadolint) is a Dockerfile linter that helps you build [best practice](https://docs.docker.com/build/building/best-practices/) Docker images. I use it in all of my projects to ensure I'm creating small, secure, efficient and maintainable images.
...
LABEL org.website="johnnymetz.com"
...
[Dockerfile labels](https://docs.docker.com/build/building/best-practices/#label) are an excellent tool for annotating your Docker images. Hadolint comes with some validation options for ensuring your labels are set correctly.

The `--require-label LABELSCHEMA` option verifies that your labels follow a specific format. You can see all acceptable format values [here](https://github.com/hadolint/hadolint#linting-labels).
...
LABEL org.website="https://johnnymetz.com/"
